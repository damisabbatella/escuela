                ...
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default" id="listartodos">
                            ...
                            <div class="col-md-4">
                                  <button class="btn btn-md btn-success" onclick="location.href='nuevousuario.php'"><i class="fa fa-home fa-plus"></i>Nuevo</button>
                                    <button class="btn btn-md btn-warning" onclick="editarusuario()"><i class="fa fa-home fa-pencil"></i>Editar</button>
...
<input type="hidden" id="mostrarlistado" value="2" />
        <input type="hidden" value="admin|email|contrasena|foto" id="columnas"/>
