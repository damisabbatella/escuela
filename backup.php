...
<? include("includes/inc_nav.php") ?>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="col-lg-8 form-group">
                                ...
                                <input type="hidden" class="form-control col-lg-8 col-xs-6" id="buscar"  placeholder="buscar por nombre">
                            ...
                            <div class="col-md-4">
                                    <button class="btn btn-md btn-success" onclick="hacerBC()"><i class="fa fa-home fa-plus"></i>Nuevo</button>
                                    
                                    <button class="btn btn-md btn-danger" onclick="borrarbackup()"><i class="fa fa-home fa-ban"></i>Borrar</button>
                            </div>
                        </div>
                            </div>
    ...
    <!-- /#wrapper -->
        ...
        <input type="hidden" value="fecha|archivo" id="columnas"/>
