                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="col-lg-8 form-group">
                               ...
                               <div id="respconsulta"></div>
                           <div class="form-group input-group">
                                <input type="text" class="form-control col-lg-8 col-xs-6" id="buscar" onKeyUp="asistente_busquedanuevo(0)" placeholder="buscar por archivados">
                            ...
                            <div class="col-md-4">
                                  ...
                                  <button class="btn btn-md" onClick="mostrar_listado2()">ver consultas</button>
...
<div class="modal fade" id="ventanaeditar" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content" id="formeditar">
       ...
       <textarea id="respconsulta"></textarea>
      </div>
