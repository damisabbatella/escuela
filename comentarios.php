                            ...
                            <div class="panel-body ">
                                <div class="table-responsive ">
                                    <table class="table table-bordered table-hover table-striped col-lg-12">
                                        <thead>
                                            <tr>
                                                <th class="col-lg-1"><input id="check_general" type="checkbox" onClick="chequeo()"/></th>
                                                <th class="col-lg-1">leccion</th>
                                                <th class="col-lg-1">Alumno</th>                                             
                                                <th class="col-lg-3">pregunta</th>
                                                <th class="col-lg-1">Respondido por</th>
                                                
                                                <th class="col-lg-3">respuesta</th>                                                                               
...
<input type="hidden" id="mostrarlistado" value="2" />
        <input type="hidden" value="idleccion|idusuario|fechapreg|pregunta|fecharesp|respuesta|idamin|estado" id="columnas"/>
        <input type="hidden" value="comentarios" id="tabla"/>
