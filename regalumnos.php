                ...
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default" id="listartodos">
                            ...
                            <div class="col-md-4">
                                  <button class="btn btn-md btn-success" onclick="location.href='nuevoalumno.php'"><i class="fa fa-home fa-plus"></i>Nuevo</button>
                                    <button class="btn btn-md btn-warning" onclick="editaralumnos()"><i class="fa fa-home fa-pencil"></i>Editar</button>
