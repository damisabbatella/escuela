...
<form id="miFormulario" action="includes/altacurso.php" method="POST" enctype="multipart/form-data">
    <div id="formulario">
        ...
        <div class="form-group">
            <label>Imagen</label>
            <input name="foto_portada" class="form-control" id="campo3" type="file"/>
        </div>
        
    </div>


    <button type="button" value="Aceptar" class="btn btn-default" onClick="validarcurso(0)">Aceptar</button>
