        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><strong>Marcelo Lopez</strong>
                                        </h5>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="bootstrap-grid.html"><i class="fa fa-fw fa-wrench"></i> Bootstrap Grilla</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="blank-page.html"><i class="fa fa-fw fa-file"></i> Pagina en Blanco</a>
                    </li>
                    <li>
                        <a href="index-rtl.html"><i class="fa fa-fw fa-dashboard"></i>panel derecho</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Todavia no respondiste todas las preguntas.</strong> Ir a  <a href="http://startbootstrap.com/template-overviews/sb-admin-2" class="alert-link">Preguntas</a> para responder!
                        </div>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i> Canales Venta </h3>
                            </div>
                            <div class="panel-body">
                                <div id="morris-donut-chart"></div>
                                <div class="text-right">
                                    <a href="#">Ver <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    ...
                                    <a href="#" class="list-group-item">
                                        ...
                                        <i class="fa fa-fw fa-comment"></i> Comentario a un post
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">hace 23 minutos</span>
                                        <i class="fa fa-fw fa-truck"></i> Item 392 enviado
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">hace 46 minutos</span>
                                        <i class="fa fa-fw fa-money"></i> Factura 653 pagada
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">hace 1 hora</span>
                                        <i class="fa fa-fw fa-user"></i>Nuevo usuario fue agregado
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">hace dos horas</span>
                                        <i class="fa fa-fw fa-check"></i> Tarea completada: "hacer backup"
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">ayer</span>
                                        <i class="fa fa-fw fa-globe"></i> Salvamos las ballenas
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">hace dos días</span>
                                        <i class="fa fa-fw fa-check"></i> tarea completada: "arreglar error en pagina de ventas"
                                    </a>
                                </div>
                                <div class="text-right">
