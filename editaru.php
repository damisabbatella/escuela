...
<html lang="en">
    ...
    <body>
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
            <?php
            $sql="SELECT * from usuarios where id=".$_GET["usuario"]." and status=1";
            $resultado=mysqli_query($con,$sql);
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form id="miFormulario"  method="POST" enctype="multipart/form-data" action="includes/usuarios/editarusuario.php?id=<?=$fila["id"]?>"  >
                        <div id="formulario">
