                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default" id="listartodos">
                            ...
                            <div class="panel-body ">
                                ...
                                Saldo de caja<input type="text" id="saldocaja" class="form-control">
...
<input type="hidden" value="fecha|descripcion|egreso|ingreso" id="columnas"/>
        <input type="hidden" value="caja" id="tabla"/>
