...
<? include("includes/inc_nav.php") ?>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="col-lg-8 form-group">
                                ...
                                <span class="input-group-btn"><button class="btn btn-default" type="button" onClick="mostrar_listado()"><i class="fa fa-search"></i></button></span>
                            </div>
    ...
    <!-- /#wrapper -->
        ...
        <input type="hidden" value="nombre|email|password" id="columnas"/>
