...
$contra= md5($_POST['datos2']);
$sql = "INSERT INTO usuarios (admin,email,contrasena,foto,status) values ('".$_POST['datos0']."','".$_POST['datos1']."','".$contra."','".$nuevo_nombre."',1)";
...
header('Location:../usuarios.php');
 ...
 $sql = "INSERT INTO usuarios (admin,email,contrasena,status) values ('".$_POST['datos0']."','".$_POST['datos1']."','".$contra."',1)";
