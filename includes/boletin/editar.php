...
?>
                ...
                <li class="dropdown">
                   <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img class="imagenp" src="../../fotos/portfolio/<?php echo $imagen ?>"><b class="caret"></b>HOLA &nbsp;<?php echo $_SESSION["usuario"];?></b> </a>
