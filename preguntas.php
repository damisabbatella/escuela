                ...
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="col-md-8">
                                    <button class="btn btn-md btn-success" onclick="nuevo()"><i class="fa fa-home fa-plus"></i>Nueva pregunta</button>
                                     <button class="btn btn-md btn-success" onclick="respuesta()"><i class="fa fa-home fa-plus"></i>agregar respuesta</button>
                                    <button class="btn btn-md btn-warning" onclick="editarpreguntas()"><i class="fa fa-home fa-pencil"></i>Editar</button>
...
<input type="hidden" id="mostrarlistado" value="2" />
        <input type="hidden" value="idcurso|idcapitulo|texto" id="columnas"/>
        <input type="hidden" value="preguntas" id="tabla"/>
